        ...
        <div className="md:col-span-6 col-span-12 flex justify-center items-start">
          <div>
            <h2 className="xl:text-[54px] md:xl:text-[38px] text-[28px] text-light-text ml-4 max-w-[550px]">
              TRADING BASE ON MODERN FLATFORM
            </h2>
            <p className="max-w-[500px] text-[16px] md:text-[20px] ml-4">
              The deep technology behind it will make ZkBullish become a robust trading platform.
              Polygon zkEVM harnesses the power of ZK proofs to reduce transaction costs and help
              the user have a better experience with a perfect security system.
            </p>
